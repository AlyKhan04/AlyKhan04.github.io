  ...
  return (
    <section id="about" className="text-white py-16 px-4 sm:px-8 lg:px-16 bg-black min-h-screen">
      <div className="flex flex-col gap-6 md:grid md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
        ...
        {/* Welcome Box */}
        <div className="md:col-span-2 relative p-6 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-lg">
        ...
        {/* About Me */}
        <div className="relative p-6 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-lg">
        ...
        {/* Song of the Month */}
        <div className="relative p-6 rounded-xl border border-white/10 bg-white/5 backdrop-blur-md shadow-lg md:h-full">
          <SongOfTheMonth />
        </div>
      </div>
    </section>
